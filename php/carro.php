...
if(isset($_POST["add"])) 
{
	if(isset($_SESSION["cart"])) // inicializamos la sesion
	{
		...
		if(!in_array($_GET["id"], $item_array_id)) 
		{
			...
			'item_name' => $_POST["hidden_name"], // traigo el elemnto del index.php
			'product_salary' => $_POST["hidden_salary"], // traigo el elemnto del index.php
			'item_quantity' => $_POST["quantity"] // traigo el elemnto del index.php
			);
		...
		{
			echo '<script>alert("El plato ha sido añadido a tu cuenta")</script>'; //checkeo con alert
	...
	else
	{
		...
		'product_salary' => $_POST["hidden_salary"],
